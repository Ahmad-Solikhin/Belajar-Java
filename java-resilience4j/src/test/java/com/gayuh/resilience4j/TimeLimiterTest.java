...
public class TimeLimiterTest {
    ...
    void test() throws Exception {
        ...
        TimeLimiter timeLimiter = TimeLimiter.ofDefaults("gayuh");
    ...
    void timeLimiterConfig() throws Exception {
        ...
        TimeLimiter timeLimiter = TimeLimiter.of("gayuh", config);
        Callable<String> callable = TimeLimiter.decorateFutureSupplier(timeLimiter, () -> future);
    ...
    void timeLimiterRegistry() throws Exception {
        ...
        TimeLimiter timeLimiter = registry.timeLimiter("gayuh", "config");
        Callable<String> callable = TimeLimiter.decorateFutureSupplier(timeLimiter, () -> future);
