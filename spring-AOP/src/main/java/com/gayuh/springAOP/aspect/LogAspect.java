package com.gayuh.springAOP.aspect;
...
public class LogAspect {
    ...
    @Pointcut("target(com.gayuh.springAOP.service.HelloService)")
    public void helloServiceMethod(){

    }

    //Advice yang sama bisa dibuat lebih dari 1 kali, yang penting nama methodnya beda aja
    ...
    @Pointcut("execution(* com.gayuh.springAOP.service.HelloService.*(java.lang.String))")
    ...
    @Pointcut("execution(* com.gayuh.springAOP.service.*.*(..))")
